                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" data-toggle="input-mask"
                                        data-mask-format="00/00/0000" name="name" value="{{ $data->name }}">
                                    <span class="font-13 text-muted">e.g "DD/MM/YYYY"</span>
                                </div>
                                <div class="form-group">
                                    <label for="">Desc</label>
                                    <textarea name="desc" class="form-control" cols="80" rows="10" style="width: 100%;border-radius: 5px;">{{ $data->desc }}"</textarea>
                                </div>
                            </div> <!-- end col -->
                                        ...
                                        @if (!empty($allCate))
                                            ...
                                            @foreach ($allCate as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('cate_id') == $item->id || $data->cate_id == $item->id ? 'selected' : false }}>
