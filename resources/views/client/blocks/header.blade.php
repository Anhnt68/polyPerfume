        ...
        <div class="container">
                        ...
                        <div class="header-links">
                            ...
                            <div class="header-link dropdown-link header-account">
                                ...
                                <div class="dropdown-container right">
                                    ...
                                    <div class="top-text">If you have an account with us, please log in.
                                    </div>
                                    <!-- form -->
                                    <form action="#">
                                    ...
                                    <div class="bottom-text">Create a <a href="account-create.html">New
                                            Account</a></div>
                                </div>
                            </div>
                            <!-- /Header Account -->
            ...
            <div class="header-logo">
                <a href="index-2.html" title="Logo">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="175px"
                        height="72px" viewBox="0 0 175 72" enable-background="new 0 0 175 72" xml:space="preserve">
                        <path
                            d="M42.913,25.454c-0.159-0.681-0.663-1.109-1.117-1.453c-3.122-2.375-6.649-4.239-10.468-5.54
                        ...
                        <g>
                            <path
                                d="M69.91,30.947c-0.941-0.564-1.915-1.066-2.919-1.506c-0.848-0.376-1.798-0.729-2.848-1.059
                        ...
                        <path
                            d="M90.294,53.922c-2.165,0-4.096-0.338-5.79-1.012c-1.695-0.674-3.115-1.594-4.262-2.753
                        ...
                        <path
                            d="M106.818,26.616v-7.532h8.944v7.532H106.818z M106.818,53.45V28.688h8.944V53.45H106.818z" />
                        <path
                            d="M136.618,53.45l-5.601-9.039l-1.789,1.979v7.061h-8.947V19.084h8.947v18.784l6.589-9.18h9.417l-8.522,10.827
                                l9.371,13.935H136.618z" />
                        <path
                            d="M158.697,53.922c-2.229,0-4.182-0.354-5.861-1.059c-1.681-0.705-3.092-1.647-4.237-2.823
            ...
            <div class="mobilemenu dblclick">
                ...
                <div class="mobilemenu-content">
                    <ul class="nav">
                        <li><a href="index-2.html">HOME</a><span class="arrow"></span>
                            <ul>
                                <li> <a href="index-2.html" title="">Default</a> </li>
                                <li> <a href="index-bg-white.html" title="">White Background</a>
                                </li>
                                <li> <a href="index-layout-6.html" title="">Wide + Side Panel</a>
                                </li>
                                <li> <a href="index-layout-1.html" title="">Classic</a> </li>
                                <li> <a href="index-layout-2.html" title="">Journal<span class="menu-label">new
                                            look</span></a> </li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="category-fixed-sidebar.html" title="">Listing<span
                                            class="menu-label-alt">NEW FEATURES</span></a><span class="arrow"></span>
                                    <ul>
                                        ...
                                        <li><a href="category-no-filter.html" title="">Listing No
                                                Filter</a>
                                        </li>
                                ...
                                <li>
                                    <a href="index-2.html" title="">Headers</a><span class="arrow"></span>
                                    <ul>
                                        <li> <a href="header-variant-1.html" title="">Header 1 (one
                                                row
                                                shift)</a> </li>
                                        <li> <a href="header-variant-2.html" title="">Header 2 (one
                                                row)</a>
                                        </li>
                                        <li> <a href="header-variant-3.html" title="">Header 3 (one
                                                row
                                                dark)</a> </li>
                                        <li> <a href="header-variant-4.html" title="">Header 4
                                                (three
                                                rows)</a> </li>
                                        <li> <a href="header-variant-5.html" title="">Header 5 (two
                                                rows)</a> </li>
                                        <li> <a href="header-variant-6.html" title="">Header 6 (two
                                                rows
                                                center)</a> </li>
                                        <li> <a href="header-variant-7.html" title="">Header 7
                                                (three
                                                row)</a> </li>
                                ...
                                <li>
                                    <a href="index-2.html" title="">Footers</a><span class="arrow"></span>
                                    <ul>
                                        <li> <a href="footer-variant-1.html" title="">Footer 1
                                                (simple)</a>
                                        </li>
                                        <li> <a href="footer-variant-2.html" title="">Footer 2
                                                (links)</a>
                                        </li>
                                        <li> <a href="footer-variant-3.html" title="">Footer 3
                                                (menu)</a>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li> <a href="gallery.html" title="">Gallery 2 in row</a>
                                        </li>
                                        <li> <a href="gallery-3-per-row.html" title="">Gallery 3 in
                                                row</a>
                                        </li>
                                        <li> <a href="gallery-simple.html" title="">No isotope
                                                Gallery</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li> <a href="blog-single.html" title="">Single Post</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li> <a href="coming-soon.html" title="">Coming soon</a>
                                        </li>
                        ...
                        <div class="sub-menu">
                            <div class="container">
                                <div class="megamenu-categories column-5">
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-2.html"><img
                                                src="images/layout/layout-1.jpg" alt /></a>
                                        <div class="category-title"><a href="#">Default</a></div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-layout-6.html"><img
                                                src="images/layout/layout-2.jpg" alt /></a>
                                        <div class="category-title"><a href="#">Fullwidth + Left
                                                SideBar</a>
                                        </div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-layout-1.html"><img
                                                src="images/layout/layout-3.jpg" alt /></a>
                                        <div class="category-title"><a href="#">Classic</a></div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-layout-3.html"><img
                                                src="images/layout/layout-4.jpg" alt /></a>
                                        <div class="category-title"><a href="#">Banners Boom</a>
                                        </div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-layout-4.html"><img
                                                src="images/layout/layout-6.jpg" alt /></a>
                                        <div class="category-title"><a href="#">Amason (vertical
                                                menu)</a>
                                        </div>
                                    </div>
                                    <!-- /megamenu column -->
                            ...
                            <div class="container">
                                <div class="megamenu-categories column-5">
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-layout-5.html"><img
                                                src="images/layout/layout-7.jpg" alt /></a>
                                        <div class="category-title"><a href="#">LookBook</a></div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-layout-2.html"><img
                                                src="images/layout/layout-5.jpg" alt /></a>
                                        <div class="category-title"><a href="#">Journal View</a>
                                        </div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-rtl.html"><img
                                                src="images/layout/layout-8.jpg" alt /></a>
                                        <div class="category-title"><a href="#">RTL Mode</a></div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="index-bg-white.html"><img
                                                src="images/layout/layout-9.jpg" alt /></a>
                                        <div class="category-title"><a href="#">White Background</a>
                                        </div>
                                    </div>
                                    <!-- /megamenu column -->
                                    <!-- megamenu column -->
                                    <div class="col">
                                        <a class="category-image" href="gallery.html"><img
                                                src="images/layout/layout-10.jpg" alt /></a>
                    ...
                    <li class="simple-dropdown">
                        ...
                        <div class="sub-menu">
                            <ul class="category-links">
                                ...
                                <li>
                                    <a href="index-2.html" title="">Headers</a>
                                    <ul>
                                        <li> <a href="header-variant-1.html" title="">Header 1 (one
                                                row
                                                shift)</a> </li>
                                ...
                                <li>
                                    <a href="index-2.html" title="">Footers</a>
                                    <ul>
                                        <li> <a href="footer-variant-1.html" title="">Footer 1
                                                (simple)</a>
                                        </li>
                                ...
                                <div class="megamenu-categories column-4">
                                    ...
                                    <div class="col">
                                        ...
                                        <ul class="category-links">
                                            ...
                                            <li><a href="#"><b>Sale Shoes</b><span class="menu-label">THREE
                                                        DAYS ONLY!</span></a></li>
                            ...
                            <div class="container">
                                <div class="megamenu-right width-25">
                                    <div class="banner style-1 autosize-text" data-fontratio="4.2">
                                        <img src="{{ asset('assets/client/images/banners/banner-1.jpg') }}"
                                            alt="Banner">
                                ...
                                <div class="megamenu-categories column-2">
                                    ...
                                    <div class="col">
                                        <a class="category-image" href="#"><img
                                                src="images/category/megamenu-category-01-1.jpg" alt /></a>
                                        <div class="category-title title-border"><a href="#">ACCESSORIES<span
                                                    class="menu-label">HOT</span></a>
                                        </div>
                                        <ul class="category-links column-count-2">
                                            <li><a href="#">Belt Buckles</a></li>
                                            <li><a href="#">Collar Tips</a></li>
                                            <li><a href="#">Fascinators & Headpieces<span class="menu-label">HOT
                                                        PRICE</span></a></li>
                                    ...
                                    <div class="col">
                                        <a class="category-image" href="#"><img
                                                src="images/category/megamenu-category-02-1.jpg" alt /></a>
                                    ...
                                    <div class="megamenu-bottom">
                                        <a href="#"><img class="img-responsive"
                                                src="images/banners/banner-megamenu.jpg" alt="megamenu banner"></a>
                                    </div>
                                    <!-- /megamenu bottom -->
                                </div>
                            </div>
                                ...
                                <div class="megamenu-left width-33">
                                    <a href="#bannerLink" class="banner-wrap">
                                        <div class="banner style-13 autosize-text image-hover-scale"
                                            data-fontratio="4">
                                            <img src="{{ asset('assets/client/images/banners/banner-21.jpg') }}"
                                                alt="Banner">
                                ...
                                <div class="megamenu-categories column-3">
                                    ...
                                    <div class="col">
                                        <a class="category-image light" href="#"><img
                                                src="{{ asset('assets/client/images/category/megamenu-category-07.jpg') }}"
                                                alt /></a>
                                    ...
                                    <div class="col">
                                        <a class="category-image light" href="#"><img
                                                src="{{ asset('assets/client/images/category/megamenu-category-09.jpg') }}"
                                                alt /></a>
                                    ...
                                    <div class="col truncateList" data-list-items="7">
                                        <a class="category-image light" href="#"><img
                                                src="{{ asset('assets/client/images/category/megamenu-category-08.jpg') }}"
                                                alt /></a>
                                        <div class="category-title title-border"><a href="#">Video
                                                Games<span class="menu-label">HOT</span></a>
                                            <span class="view-all"><span class="all">view
                                                    all...</span><span class="less">view
                                                    less...</span></span>
                                        </div>
                                        <ul class="category-links">
                                            ...
                                            <li><a href="#"><i class="icon icon-gift"></i> Gaming
                                                    Gift
                                                    Cards</a></li>
                                            <li><a href="#">PlayStation 4</a></li>
                                            <li><a href="#">Xbox One</a></li>
