                        ...
                        <div class="footer-logo">
                            <a href="#">
                                <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    width="175px" height="72px" viewBox="0 0 175 72"
                                    enable-background="new 0 0 175 72" xml:space="preserve">
                                    <path
                    ...
                    <div class="footer-block collapsed-mobile">
                        ...
                        <div class="collapsed-content">
                            ...
                            <div class="footer-social">
                                <a href="#"><i class="icon icon-facebook-logo icon-circled"></i></a> <a
                                    href="#"><i class="icon icon-twitter-logo icon-circled"></i></a> <a
                                    href="#"><i class="icon icon-skype-logo icon-circled"></i></a> <a
                                    href="#"><i class="icon icon-vimeo icon-circled"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-8">
                    <div class="image-banner text-center">
                        <a href="#"> <img src="{{ asset('assets/client/images/banners/footer-banner.jpg') }}"
